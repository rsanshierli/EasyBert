...
def build_dataset(config):
    ...
    train = load_dataset(config.train_path, config.pad_size)    # 训练
    dev = load_dataset(config.dev_path, config.pad_size)        # 验证
    test = load_dataset(config.test_path, config.pad_size)      # 测试
